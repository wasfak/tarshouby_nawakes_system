...
import { getAlama } from "../actions/getAlama";

export default function AlamaPage() {
  ...
  const exportToExcel = (data, fileName) => {
    ...
    const columns = ["name", "code", "company", "sales", "stock", "order"];
  ...
  return (
    <div>
      <h1 className="font-bold text-center">
        اصنف موجود ف المخزن رصيد اكتر من بيع 55يوم على الاقل ب 150 علبة
      </h1>
      <Button
          ...
          <table className="min-w-full bg-white border border-gray-300 text-left">
            <thead>
              <tr>
                ...
                <th className="border border-gray-300 px-6 py-4">Sales</th>
                <th className="border border-gray-300 px-6 py-4">Stock</th>
                <th className="border border-gray-300 px-6 py-4">Order</th>
              </tr>
            </thead>
            <tbody>
